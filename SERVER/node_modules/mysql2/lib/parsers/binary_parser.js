...
const FieldFlags = require('mysql2/lib/constants/field_flags.js');
const Charsets = require('mysql2/lib/constants/charsets.js');
const Types = require('mysql2/lib/constants/types.js');
const helpers = require('mysql2/lib/helpers');
const genFunc = require('generate-function');
const parserCache = require('mysql2/lib/parsers/parser_cache.js');
const typeNames = [];
