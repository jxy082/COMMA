...
import Asn1SequenceDecoder from 'jose/dist/node/esm/runtime/asn1_sequence_decoder.js';
import { JOSENotSupported } from 'jose/dist/node/esm/util/errors.js';
import getNamedCurve from 'jose/dist/node/esm/runtime/get_named_curve.js';
...
import { jwkExport } from 'jose/dist/node/esm/runtime/flags.js';
const keyToJWK = (key) => {
    let keyObject;
    if (isCryptoKey(key)) {
        if (!key.extractable) {
