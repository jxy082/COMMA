...
import { setCurve } from 'jose/dist/node/esm/runtime/get_named_curve.js';
import { setModulusLength } from 'jose/dist/node/esm/runtime/check_modulus_length.js';
import Asn1SequenceEncoder from 'jose/dist/node/esm/runtime/asn1_sequence_encoder.js';
import { jwkImport } from 'jose/dist/node/esm/runtime/flags.js';
const parse = (jwk) => {
