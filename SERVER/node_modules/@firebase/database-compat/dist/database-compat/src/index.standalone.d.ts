...
import { Database } from '@firebase/database-compat/dist/database-compat/src/api/Database';
import * as INTERNAL from '@firebase/database-compat/dist/database-compat/src/api/internal';
import { DataSnapshot, Query, Reference } from '@firebase/database-compat/dist/database-compat/src/api/Reference';
...
export { DataSnapshot } from '@firebase/database-compat/dist/database-compat/src/api/Reference';
