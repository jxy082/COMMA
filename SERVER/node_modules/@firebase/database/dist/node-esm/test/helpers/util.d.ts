 ...
 */
import { Database, DatabaseReference } from '@firebase/database/dist/node-esm/src';
import { Path } from '@firebase/database/dist/node-esm/src/core/util/Path';
import { EventAccumulator } from '@firebase/database/dist/node-esm/test/helpers/EventAccumulator';
...
export declare function testRepoInfo(url: any): import("@firebase/database/dist/node-esm/src/core/RepoInfo").RepoInfo;
export declare function repoInfoForConnectionTest(): import("@firebase/database/dist/node-esm/src/core/RepoInfo").RepoInfo;
