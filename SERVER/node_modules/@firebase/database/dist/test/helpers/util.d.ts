 ...
 */
import { Database, DatabaseReference } from '@firebase/database/dist/src';
import { Path } from '@firebase/database/dist/src/core/util/Path';
import { EventAccumulator } from '@firebase/database/dist/test/helpers/EventAccumulator';
...
export declare function testRepoInfo(url: any): import("@firebase/database/dist/src/core/RepoInfo").RepoInfo;
export declare function repoInfoForConnectionTest(): import("@firebase/database/dist/src/core/RepoInfo").RepoInfo;
