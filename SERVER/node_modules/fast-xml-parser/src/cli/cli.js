...
const readToEnd = require('fast-xml-parser/src/cli/read').readToEnd;

const version = require('fast-xml-parser/package.json').version;
if (process.argv[2] === '--help' || process.argv[2] === '-h') {
  console.log(require("fast-xml-parser/src/cli/man"));
