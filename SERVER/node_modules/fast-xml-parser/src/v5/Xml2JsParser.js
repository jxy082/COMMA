const StringSource = require("fast-xml-parser/src/v5/inputSource/StringSource");
const BufferSource = require("fast-xml-parser/src/v5/inputSource/BufferSource");
const {readTagExp,readClosingTagName} = require("fast-xml-parser/src/v5/XmlPartReader");
const {readComment, readCdata,readDocType,readPiTag} = require("fast-xml-parser/src/v5/XmlSpecialTagsReader");
const TagPath = require("fast-xml-parser/src/v5/TagPath");
const TagPathMatcher = require("fast-xml-parser/src/v5/TagPathMatcher");
const EntitiesParser = require('fast-xml-parser/src/v5/EntitiesParser');
