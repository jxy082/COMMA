...
const {buildOptions,registerCommonValueParsers} = require("fast-xml-parser/src/v5/OutputBuilders/ParserOptionsBuilder");
...
const BaseOutputBuilder = require("fast-xml-parser/src/v5/OutputBuilders/BaseOutputBuilder");
const rootName = '^';
