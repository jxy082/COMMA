...
import { extractAndSelectServiceConfig, ServiceConfig } from '@grpc/grpc-js/src/service-config';
...
import { Endpoint, TcpSubchannelAddress } from '@grpc/grpc-js/src/subchannel-address';
import { GrpcUri, uriToString, splitHostPort } from '@grpc/grpc-js/src/uri-parser';
