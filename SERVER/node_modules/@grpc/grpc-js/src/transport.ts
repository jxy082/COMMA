...
import { PartialStatusObject } from '@grpc/grpc-js/src/call-interface';
...
import { getProxiedConnection, ProxyConnectionResult } from '@grpc/grpc-js/src/http_proxy';
import * as logging from '@grpc/grpc-js/src/logging';
import { getDefaultAuthority } from '@grpc/grpc-js/src/resolver';
import {
  stringToSubchannelAddress,
  SubchannelAddress,
  subchannelAddressToString,
} from '@grpc/grpc-js/src/subchannel-address';
import { GrpcUri, parseUri, splitHostPort, uriToString } from '@grpc/grpc-js/src/uri-parser';
import * as net from 'net';
import {
  Http2SubchannelCall,
  SubchannelCall,
  SubchannelCallInterceptingListener,
} from '@grpc/grpc-js/src/subchannel-call';
