...
import { registerResolver, Resolver, ResolverListener } from '@grpc/grpc-js/src/resolver';
import { Endpoint, SubchannelAddress } from '@grpc/grpc-js/src/subchannel-address';
import { GrpcUri, splitHostPort, uriToString } from '@grpc/grpc-js/src/uri-parser';
