...
import type { Deserialize, Serialize } from '@grpc/grpc-js/src/make-client';
import { Metadata } from '@grpc/grpc-js/src/metadata';
import type { ObjectReadable, ObjectWritable } from '@grpc/grpc-js/src/object-stream';
import type { StatusObject, PartialStatusObject } from '@grpc/grpc-js/src/call-interface';
import type { Deadline } from '@grpc/grpc-js/src/deadline';
import type { ServerInterceptingCallInterface } from '@grpc/grpc-js/src/server-interceptors';
