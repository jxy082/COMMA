...
import { LoadBalancingCall } from '@grpc/grpc-js/build/src/load-balancing-call';
import { CallCredentials } from '@grpc/grpc-js/build/src/call-credentials';
import { Call, StatusObject } from '@grpc/grpc-js/build/src/call-interface';
import { Deadline } from '@grpc/grpc-js/build/src/deadline';
import { ResolvingCall } from '@grpc/grpc-js/build/src/resolving-call';
import { RetryingCall } from '@grpc/grpc-js/build/src/retrying-call';
import { BaseSubchannelWrapper, SubchannelInterface } from '@grpc/grpc-js/build/src/subchannel-interface';
...
export declare class InternalChannel {
    ...
    doPick(metadata: Metadata, extraPickInfo: {
        [key: string]: string;
    }): import("@grpc/grpc-js/build/src/picker").PickResult;
