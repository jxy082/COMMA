import { Deserialize, Serialize, ServiceDefinition } from '@grpc/grpc-js/build/src/make-client';
...
import { ServerRef } from '@grpc/grpc-js/build/src/channelz';
import { ServerInterceptor } from '@grpc/grpc-js/build/src/server-interceptors';
