import { ChannelControlHelper, LoadBalancer, TypedLoadBalancingConfig } from '@grpc/grpc-js/build/src/load-balancer';
import { ServiceConfig } from '@grpc/grpc-js/build/src/service-config';
import { ConfigSelector } from '@grpc/grpc-js/build/src/resolver';
...
import { GrpcUri } from '@grpc/grpc-js/build/src/uri-parser';
