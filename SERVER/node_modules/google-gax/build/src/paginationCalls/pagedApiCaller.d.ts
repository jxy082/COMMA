...
import { GRPCCall, SimpleCallbackFunction, RequestType } from 'google-gax/build/src/apitypes';
import { APICallback } from 'google-gax/build/src/apitypes';
...
import { PageDescriptor } from 'google-gax/build/src/paginationCalls/pageDescriptor';
export declare class PagedApiCaller implements APICaller {
    ...
    result(ongoingCall: OngoingCallPromise): import("google-gax/build/src/call").CancellablePromise<import("google-gax/build/src/apitypes").ResultTuple>;
}
