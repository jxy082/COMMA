...
/// <reference types="node" />
/// <reference types="node" />
import { ApiError, BodyResponseCallback, DecorateRequestOptions, DeleteCallback, ExistsCallback, GetConfig, MetadataCallback, ServiceObject, SetMetadataResponse } from '@google-cloud/storage/build/cjs/src/nodejs-common';
import { RequestResponse } from '@google-cloud/storage/build/cjs/src/nodejs-common/service-object.js';
import * as http from 'http';
import { Acl, AclMetadata } from '@google-cloud/storage/build/cjs/src/acl.js';
import { Channel } from '@google-cloud/storage/build/cjs/src/channel.js';
import { File, FileOptions, CreateResumableUploadOptions, CreateWriteStreamOptions } from '@google-cloud/storage/build/cjs/src/file.js';
import { Iam } from '@google-cloud/storage/build/cjs/src/iam.js';
import { Notification } from '@google-cloud/storage/build/cjs/src/notification.js';
import { Storage, Cors, PreconditionOptions, BucketOptions } from '@google-cloud/storage/build/cjs/src/storage.js';
import { GetSignedUrlResponse, GetSignedUrlCallback, SignerGetSignedUrlConfig, URLSigner, Query } from '@google-cloud/storage/build/cjs/src/signer.js';
import { Readable } from 'stream';
import { CRC32CValidatorGenerator } from '@google-cloud/storage/build/cjs/src/crc32c.js';
import { URL } from 'url';
import { BaseMetadata, SetMetadataOptions } from '@google-cloud/storage/build/cjs/src/nodejs-common/service-object.js';
