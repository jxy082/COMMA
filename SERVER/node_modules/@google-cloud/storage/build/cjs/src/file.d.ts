...
/// <reference types="node" />
/// <reference types="node" />
import { BodyResponseCallback, DecorateRequestOptions, GetConfig, MetadataCallback, ServiceObject, SetMetadataResponse } from '@google-cloud/storage/build/cjs/src/nodejs-common';
import * as resumableUpload from '@google-cloud/storage/build/cjs/src/resumable-upload.js';
import { Writable, Readable, PipelineSource } from 'stream';
import * as http from 'http';
import { PreconditionOptions, Storage } from '@google-cloud/storage/build/cjs/src/storage.js';
import { AvailableServiceObjectMethods, Bucket } from '@google-cloud/storage/build/cjs/src/bucket.js';
import { Acl, AclMetadata } from '@google-cloud/storage/build/cjs/src/acl.js';
import { GetSignedUrlResponse, GetSignedUrlCallback, URLSigner, SignerGetSignedUrlConfig, Query } from '@google-cloud/storage/build/cjs/src/signer.js';
import { Duplexify, GCCL_GCS_CMD_KEY } from '@google-cloud/storage/build/cjs/src/nodejs-common/util.js';
import { CRC32C, CRC32CValidatorGenerator } from '@google-cloud/storage/build/cjs/src/crc32c.js';
import { URL } from 'url';
import { BaseMetadata, DeleteCallback, DeleteOptions, GetResponse, InstanceResponseCallback, RequestResponse, SetMetadataOptions } from '@google-cloud/storage/build/cjs/src/nodejs-common/service-object.js';
