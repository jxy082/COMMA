...
import { QueryDocumentSnapshot } from '@google-cloud/firestore/build/src/document';
import { DocumentChange } from '@google-cloud/firestore/build/src/document-change';
import { QueryUtil } from '@google-cloud/firestore/build/src/reference/query-util';
import { Query } from '@google-cloud/firestore/build/src/reference/query';
import { VectorQueryOptions } from '@google-cloud/firestore/build/src/reference/vector-query-options';
import { VectorQuerySnapshot } from '@google-cloud/firestore/build/src/reference/vector-query-snapshot';
import { ExplainResults } from '@google-cloud/firestore/build/src/query-profile';
import { QueryResponse } from '@google-cloud/firestore/build/src/reference/types';
/**
