...
import { QueryUtil } from '@google-cloud/firestore/build/src/reference/query-util';
import { Firestore, DocumentChange, DocumentSnapshot, FieldPath, Filter, QueryDocumentSnapshot, Timestamp } from '@google-cloud/firestore/build/src';
import { QueryOptions } from '@google-cloud/firestore/build/src/reference/query-options';
import { FieldOrder } from '@google-cloud/firestore/build/src/reference/field-order';
import { FilterInternal } from '@google-cloud/firestore/build/src/reference/filter-internal';
import { FieldFilterInternal } from '@google-cloud/firestore/build/src/reference/field-filter-internal';
import { QuerySnapshot } from '@google-cloud/firestore/build/src/reference/query-snapshot';
import { Serializer } from '@google-cloud/firestore/build/src/serializer';
import { ExplainResults } from '@google-cloud/firestore/build/src/query-profile';
import { CompositeFilter, UnaryFilter } from '@google-cloud/firestore/build/src/filter';
import { QueryResponse, QuerySnapshotResponse } from '@google-cloud/firestore/build/src/reference/types';
import { AggregateQuery } from '@google-cloud/firestore/build/src/reference/aggregate-query';
import { VectorQuery } from '@google-cloud/firestore/build/src/reference/vector-query';
/**
