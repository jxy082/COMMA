...
const query_util_1 = require("@google-cloud/firestore/build/src/reference/query-util");
const index_1 = require("@google-cloud/firestore/build/src");
const field_order_1 = require("@google-cloud/firestore/build/src/reference/field-order");
const field_filter_internal_1 = require("@google-cloud/firestore/build/src/reference/field-filter-internal");
const composite_filter_internal_1 = require("@google-cloud/firestore/build/src/reference/composite-filter-internal");
const constants_1 = require("@google-cloud/firestore/build/src/reference/constants");
const vector_query_options_1 = require("@google-cloud/firestore/build/src/reference/vector-query-options");
const document_reference_1 = require("@google-cloud/firestore/build/src/reference/document-reference");
const query_snapshot_1 = require("@google-cloud/firestore/build/src/reference/query-snapshot");
const serializer_1 = require("@google-cloud/firestore/build/src/serializer");
const query_profile_1 = require("@google-cloud/firestore/build/src/query-profile");
const filter_1 = require("@google-cloud/firestore/build/src/filter");
const path_1 = require("@google-cloud/firestore/build/src/path");
const helpers_1 = require("@google-cloud/firestore/build/src/reference/helpers");
const validate_1 = require("@google-cloud/firestore/build/src/validate");
const types_1 = require("@google-cloud/firestore/build/src/reference/types");
const aggregate_query_1 = require("@google-cloud/firestore/build/src/reference/aggregate-query");
const vector_query_1 = require("@google-cloud/firestore/build/src/reference/vector-query");
const order_1 = require("@google-cloud/firestore/build/src/order");
const types_2 = require("@google-cloud/firestore/build/src/types");
/**
...
class Query {
    ...
    onSnapshot(onNext, onError) {
        ...
        const watch = new (require('@google-cloud/firestore/build/src/watch').QueryWatch)(this.firestore, this, this._queryOptions.converter);
