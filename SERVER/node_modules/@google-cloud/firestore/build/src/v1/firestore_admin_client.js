...
const jsonProtos = require("@google-cloud/firestore/build/protos/admin_v1.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/firestore_admin_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("@google-cloud/firestore/build/src/v1/firestore_admin_client_config.json");
const version = require('@google-cloud/firestore/package.json').version;
/**
