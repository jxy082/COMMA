...
import { BulkWriter } from '@google-cloud/firestore/build/src/bulk-writer';
import { BundleBuilder } from '@google-cloud/firestore/build/src/bundle';
import { DocumentSnapshot, QueryDocumentSnapshot } from '@google-cloud/firestore/build/src/document';
import { CollectionReference } from '@google-cloud/firestore/build/src/reference/collection-reference';
import { DocumentReference } from '@google-cloud/firestore/build/src/reference/document-reference';
import { Serializer } from '@google-cloud/firestore/build/src/serializer';
import { Transaction } from '@google-cloud/firestore/build/src/transaction';
import { FirestoreStreamingMethod, FirestoreUnaryMethod } from '@google-cloud/firestore/build/src/types';
import { WriteBatch } from '@google-cloud/firestore/build/src/write-batch';
import api = google.firestore.v1;
import { CollectionGroup } from '@google-cloud/firestore/build/src/collection-group';
export { CollectionReference } from '@google-cloud/firestore/build/src/reference/collection-reference';
export { DocumentReference } from '@google-cloud/firestore/build/src/reference/document-reference';
export { QuerySnapshot } from '@google-cloud/firestore/build/src/reference/query-snapshot';
export { Query } from '@google-cloud/firestore/build/src/reference/query';
export type { AggregateQuery } from '@google-cloud/firestore/build/src/reference/aggregate-query';
export type { AggregateQuerySnapshot } from '@google-cloud/firestore/build/src/reference/aggregate-query-snapshot';
export type { VectorQuery } from '@google-cloud/firestore/build/src/reference/vector-query';
export type { VectorQuerySnapshot } from '@google-cloud/firestore/build/src/reference/vector-query-snapshot';
export { BulkWriter } from '@google-cloud/firestore/build/src/bulk-writer';
export type { BulkWriterError } from '@google-cloud/firestore/build/src/bulk-writer';
export type { BundleBuilder } from '@google-cloud/firestore/build/src/bundle';
export { DocumentSnapshot, QueryDocumentSnapshot } from '@google-cloud/firestore/build/src/document';
export { FieldValue, VectorValue } from '@google-cloud/firestore/build/src/field-value';
export { Filter } from '@google-cloud/firestore/build/src/filter';
export { WriteBatch, WriteResult } from '@google-cloud/firestore/build/src/write-batch';
export { Transaction } from '@google-cloud/firestore/build/src/transaction';
export { Timestamp } from '@google-cloud/firestore/build/src/timestamp';
export { DocumentChange } from '@google-cloud/firestore/build/src/document-change';
export type { DocumentChangeType } from '@google-cloud/firestore/build/src/document-change';
export { FieldPath } from '@google-cloud/firestore/build/src/path';
export { GeoPoint } from '@google-cloud/firestore/build/src/geo-point';
export { CollectionGroup };
export { QueryPartition } from '@google-cloud/firestore/build/src/query-partition';
export { setLogFunction } from '@google-cloud/firestore/build/src/logger';
export { Aggregate, AggregateField } from '@google-cloud/firestore/build/src/aggregate';
export type { AggregateFieldType, AggregateSpec, AggregateType, } from '@google-cloud/firestore/build/src/aggregate';
export type { PlanSummary, ExecutionStats, ExplainMetrics, ExplainResults, } from '@google-cloud/firestore/build/src/query-profile';
/**
