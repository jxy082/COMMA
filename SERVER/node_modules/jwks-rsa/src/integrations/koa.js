const { ArgumentError } = require('jwks-rsa/src/errors');
const { JwksClient } = require('jwks-rsa/src/JwksClient');
const supportedAlg = require('jwks-rsa/src/integrations/config');
