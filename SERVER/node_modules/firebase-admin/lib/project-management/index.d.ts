...
import { ProjectManagement } from 'firebase-admin/lib/project-management/project-management';
export { AppMetadata, AppPlatform } from 'firebase-admin/lib/project-management/app-metadata';
export { ProjectManagement } from 'firebase-admin/lib/project-management/project-management';
export { AndroidApp, AndroidAppMetadata, ShaCertificate } from 'firebase-admin/lib/project-management/android-app';
export { IosApp, IosAppMetadata } from 'firebase-admin/lib/project-management/ios-app';
/**
...
export { FirebaseProjectManagementError, ProjectManagementErrorCode } from 'firebase-admin/lib/utils/error';
