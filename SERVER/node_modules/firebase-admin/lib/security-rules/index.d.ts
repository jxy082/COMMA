...
import { SecurityRules } from 'firebase-admin/lib/security-rules/security-rules';
export { RulesFile, Ruleset, RulesetMetadata, RulesetMetadataList, SecurityRules, } from 'firebase-admin/lib/security-rules/security-rules';
/**
