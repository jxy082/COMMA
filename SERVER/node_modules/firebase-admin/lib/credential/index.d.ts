 ...
 */
import { Credential as TCredential, applicationDefault as applicationDefaultFn, cert as certFn, refreshToken as refreshTokenFn } from 'firebase-admin/lib/app';
export { ServiceAccount, GoogleOAuthAccessToken } from 'firebase-admin/lib/app';
