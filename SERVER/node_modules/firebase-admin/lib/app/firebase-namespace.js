...
const lifecycle_1 = require("firebase-admin/lib/app/lifecycle");
const credential_factory_1 = require("firebase-admin/lib/app/credential-factory");
const index_1 = require("firebase-admin/lib/utils");
/**
...
class FirebaseNamespace {
    ...
    get auth() {
        ...
        const auth = require('firebase-admin/lib/auth/auth').Auth;
    ...
    get messaging() {
        ...
        const messaging = require('firebase-admin/lib/messaging/messaging').Messaging;
    ...
    get storage() {
        ...
        const storage = require('firebase-admin/lib/storage/storage').Storage;
    ...
    get machineLearning() {
        ...
        const machineLearning = require('firebase-admin/lib/machine-learning/machine-learning').MachineLearning;
    ...
    get installations() {
        ...
        const installations = require('firebase-admin/lib/installations/installations').Installations;
    ...
    get instanceId() {
        ...
        const instanceId = require('firebase-admin/lib/instance-id/instance-id').InstanceId;
    ...
    get projectManagement() {
        ...
        const projectManagement = require('firebase-admin/lib/project-management/project-management').ProjectManagement;
    ...
    get securityRules() {
        ...
        const securityRules = require('firebase-admin/lib/security-rules/security-rules').SecurityRules;
    ...
    get remoteConfig() {
        ...
        const remoteConfig = require('firebase-admin/lib/remote-config/remote-config').RemoteConfig;
    ...
    get appCheck() {
        ...
        const appCheck = require('firebase-admin/lib/app-check/app-check').AppCheck;
...
function extendApp(app) {
    ...
    result.auth = () => {
        const fn = require('firebase-admin/lib/auth').getAuth;
        return fn(app);
    };
    result.appCheck = () => {
        const fn = require('firebase-admin/lib/app-check').getAppCheck;
        return fn(app);
    };
    result.database = (url) => {
        const fn = require('firebase-admin/lib/database').getDatabaseWithUrl;
        return fn(url, app);
    };
    result.messaging = () => {
        const fn = require('firebase-admin/lib/messaging').getMessaging;
        return fn(app);
    };
    result.storage = () => {
        const fn = require('firebase-admin/lib/storage').getStorage;
        return fn(app);
    };
    result.firestore = () => {
        const fn = require('firebase-admin/lib/firestore').getFirestore;
        return fn(app);
    };
    result.instanceId = () => {
        const fn = require('firebase-admin/lib/instance-id').getInstanceId;
        return fn(app);
    };
    result.installations = () => {
        const fn = require('firebase-admin/lib/installations').getInstallations;
        return fn(app);
    };
    result.machineLearning = () => {
        const fn = require('firebase-admin/lib/machine-learning').getMachineLearning;
        return fn(app);
    };
    result.projectManagement = () => {
        const fn = require('firebase-admin/lib/project-management').getProjectManagement;
        return fn(app);
    };
    result.securityRules = () => {
        const fn = require('firebase-admin/lib/security-rules').getSecurityRules;
        return fn(app);
    };
    result.remoteConfig = () => {
        const fn = require('firebase-admin/lib/remote-config').getRemoteConfig;
        return fn(app);
    };
