...
import { TenantServerResponse, CreateTenantRequest, UpdateTenantRequest } from 'firebase-admin/lib/auth/tenant';
import { ProjectConfigServerResponse, UpdateProjectConfigRequest } from 'firebase-admin/lib/auth/project-config';
