 ...
 */
import { BaseAuth, SessionCookieOptions } from 'firebase-admin/lib/auth/base-auth';
import { Tenant, CreateTenantRequest, UpdateTenantRequest } from 'firebase-admin/lib/auth/tenant';
