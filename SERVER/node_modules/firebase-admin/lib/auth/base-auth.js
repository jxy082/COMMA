...
const auth_api_request_1 = require("firebase-admin/lib/auth/auth-api-request");
const token_generator_1 = require("firebase-admin/lib/auth/token-generator");
const token_verifier_1 = require("firebase-admin/lib/auth/token-verifier");
const auth_config_1 = require("firebase-admin/lib/auth/auth-config");
const user_record_1 = require("firebase-admin/lib/auth/user-record");
const identifier_1 = require("firebase-admin/lib/auth/identifier");
const crypto_signer_1 = require("firebase-admin/lib/utils/crypto-signer");
/**
 * @internal
 */
