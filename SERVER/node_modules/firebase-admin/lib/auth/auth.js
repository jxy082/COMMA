...
const tenant_manager_1 = require("firebase-admin/lib/auth/tenant-manager");
const base_auth_1 = require("firebase-admin/lib/auth/base-auth");
const project_config_manager_1 = require("firebase-admin/lib/auth/project-config-manager");
/**
