...
import { InstanceId } from 'firebase-admin/lib/instance-id/instance-id';
export { InstanceId };
/**
...
export { FirebaseInstanceIdError, InstanceIdClientErrorCode } from 'firebase-admin/lib/utils/error';
